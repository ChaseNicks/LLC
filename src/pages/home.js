...
const Home = () => {
  return (
    <div>
      ...
      <div className="container cont-img is-one-third" style={{ width: "100%", display: "flex", flexDirection: "row", justifyContent: "center", height: "fit-content" }}>
        <div className="columns">
          <div className="column" style={{ marginTop: "2rem", marginLeft: "1.5rem"}}>
            <h1 className="is-size-2" style={{ paddingBottom: "2rem"}}>Digital services</h1>
            <p className="is-size-4" style={{ paddingBottom: "1.3rem"}}>Empowering individuals and business owners to utilize this digital age to benefit them most.</p>
            <button
                    type="submit"
      ...
      <div style={{ background: "linear-gradient(to right, #972EFF , #E197FD)", height: ".5rem" }}></div>
      ...
      <div style={{ backgroundColor: "black", color: "white" }}>
        ...
        <div className="columns" style={{ marginLeft: "1rem", marginRight: "1rem", marginBottom: "3rem" }}>
          ...
          <div className="column is-one-forth is-flex is-flex-direction-column is-align-items-center" style={{ marginLeft: "1rem", marginRight: "1rem" }}>
            ...
            />
            <h2 className="is-size-3 has-text-centered" style={{ paddingBottom: ".7rem" }}>Custome Site</h2>
            <p className={"has-text-centered"} style={{ paddingBottom: "1.5rem", marginLeft: "1rem", marginRight: "1rem" }}>
        ...
        <div className="columns" style={{ marginLeft: "1rem", marginRight: "1rem" }}>
          ...
          <div className="column is-one-forth is-flex is-flex-direction-column is-align-items-center" style={{ marginLeft: "1rem", marginRight: "1rem" }}>
            ...
            <p className={"has-text-centered"} style={{ paddingBottom: "1.5rem", marginLeft: "1rem", marginRight: "1rem" }}>
              Got an existing site that is slowly fadding behind modern style and look? Maybe even as simple as new feature added? We got you covered.
            </p>
          </div>
        </div>
      </div>
